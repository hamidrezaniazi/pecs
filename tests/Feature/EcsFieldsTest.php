...
class EcsFieldsTest extends TestCase
{
    ...
    public function testItShouldFormatAnyEcsFieldCorrectly(): void
    {
        ...
        $base = new Base(
            timestamp: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
        ...
        $dll = new Dll(
            ...
            pe: new Pe(
                ...
                goImportsNamesEntropy: 1,
                goImportsNamesVarEntropy: 1,
                goStripped: true,
                imphash: 'string',
                imports: (new ValueList())->push('string'),
                importsNamesEntropy: 1,
                importsNamesVarEntropy: 1,
        ...
        $elf = new Elf(
            ...
            byteOrder: 'string',
            cpuType: 'string',
            creationDate: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
        ...
        $email = new Email(
            ...
            contentType: 'string',
            deliveryTimestamp: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            direction: 'string',
            fromAddress: (new ValueList())->push('info@example.test'),
            localId: 'string',
            messageId: 'string',
            originationTimestamp: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
        ...
        $event = new Event(
            ...
            code: 'string',
            created: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            dataset: 'string',
            duration: 123456,
            end: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            hash: 'string',
            id: 'string',
            ingested: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            ...
            sequence: 123456,
            severity: 123456,
            start: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            timezone: CarbonTimeZone::create('Asia/Tehran'),
        ...
        $file = new File(
            accessed: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            attributes: (new FileAttributeList())->push(FileAttribute::ARCHIVE),
            created: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            ctime: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            device: 'string',
            driveLetter: 'string',
            extension: 'string',
            forkName: 'string',
            ...
            mimeType: 'string',
            mode: 'string',
            mtime: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            name: 'string',
            owner: 'string',
            path: 'string',
            size: 123456,
            ...
            x509: new X509(
                ...
                notAfter: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
                notBefore: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
        ...
        $package = new Package(
            ...
            description: 'string',
            installScope: 'string',
            installed: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            license: 'string',
            name: 'string',
            path: '/file/path/',
            size: 123456,
        ...
        $threat = new Threat(
            enrichments: (new ThreatEnrichmentList())->push(
                new ThreatEnrichment(
                    ...
                    indicatorFirstSeen: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
                    indicatorIp: '8.8.8.8',
                    indicatorLastSeen: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
                    indicatorMarkingTlp: ThreatMarkingTlp::WHITE,
                    indicatorMarkingTlpVersion: 'string',
                    indicatorMarkingModifiedAt: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
                    ...
                    matchedField: 'string',
                    matchedId: 'string',
                    matchedOccurred: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
                    matchedType: 'string',
        ...
        $tls = new TLS(
            ...
            clientIssuer: 'string',
            clientJa3: 'string',
            clientNotAfter: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            clientNotBefore: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            ...
            serverIssuer: 'string',
            serverJa3s: 'string',
            serverNotAfter: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
            serverNotBefore: Carbon::parse('2000-01-01 01:11:11.000000 Europe/Amsterdam'),
